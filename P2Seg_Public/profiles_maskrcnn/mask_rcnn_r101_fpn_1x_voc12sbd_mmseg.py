...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='CocoFmtDataset',
            ann_file=
            'projects/BESTIE/checkpoints/voc/base_ppg_aff_affrefine_resnet101/voc_data/voc12sbd_ins_train_cls_refine.json',
...
resume_from = None
workflow = [('train', 1)]
work_dir = '../TOV_mmdetection_cache/work_dir/configs3/VOC12/mask_rcnn_r101_fpn_1x_voc12sbd_mmseg/base_ppg_aff_affrefine'
gpu_ids = range(0, 4)
